...
import { UniqueEntityID, Result, Guard, AggregateRoot } from "@japahubs/shared";
...
export class User extends AggregateRoot<UserProps> {
  ...
  public static create(
    ...
    if (!isRegister && isNewUser) {
      user.addDomainEvent(new UserCreatedEvent(eventData), DomainEvents);
    }
    if (isRegister) {
      user.addDomainEvent(new UserRegisteredEvent(eventData), DomainEvents);
    }
